...
public class ScondaryPrgressBar extends Animation {
     ...
     */
    public ScondaryPrgressBar(ProgressBar progressBar, long fullDuration) {
        super();
    ...
    protected void applyTransformation(float interpolatedTime, Transformation t) {
        ...
        mProgressBar.setSecondaryProgress((int) value);
    }
}
