package com.skyinbrowser.weather.tasks;
...
public abstract class GenericRequestTaskTwo extends AsyncTask<String, String, TaskOutput> {
    ...
    public GenericRequestTaskTwo(Context context, Mpage activity, ProgressDialog progressDialog) {
