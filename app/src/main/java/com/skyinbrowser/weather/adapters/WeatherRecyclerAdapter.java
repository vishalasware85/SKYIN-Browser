package com.skyinbrowser.weather.adapters;
...
import com.skyinbrowser.weather.models.WeatherViewHolder;
        ...
        if (sp.getBoolean("differentiateDaysByTint", false)) {
            ...
            if (weatherItem.getNumDaysFrom(now) > 1) {
                ...
                if (weatherItem.getNumDaysFrom(now) % 2 == 1) {
                    color = ta.getColor(0, context.getResources().getColor(R.color.weather_colorTintedBackground));
                } else {
