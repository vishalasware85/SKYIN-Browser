...
public class National extends Fragment implements  SwipeRefreshLayout.OnRefreshListener{
    ...
    public static National getInstance(String title) {
        National sf = new National();
        return sf;
    }
    ...
    private void loadData(){
        ...
        Gson gson = new Gson();
        if (preferences.contains("nationalNews")){
            String json = preferences.getString("nationalNews", null);
    ...
    private void saveData(){
        ...
        editor.putString("nationalNews",json);
        editor.apply();
    }
