...
public class Techno extends Fragment implements  SwipeRefreshLayout.OnRefreshListener{
    ...
    public static Techno getInstance(String title){
        Techno sf=new Techno();
        return sf;
    }
    ...
    private void loadData(){
        ...
        Gson gson = new Gson();
        if (preferences.contains("technoNews")){
            String json = preferences.getString("technoNews", null);
    ...
    private void saveData(){
        ...
        editor.putString("technoNews",json);
        editor.apply();
    }
