...
public class Sports extends Fragment implements  SwipeRefreshLayout.OnRefreshListener{
    ...
    public static Sports getInstance(String title){
        Sports sf=new Sports();
        return sf;
    }
    ...
    private void loadData(){
        ...
        Gson gson = new Gson();
        if (preferences.contains("sportsNews")){
            String json = preferences.getString("sportsNews", null);
    ...
    private void saveData(){
        ...
        editor.putString("sportsNews",json);
        editor.apply();
    }
    ...
    private interface topHeadlinesApi {
        ...
        @GET("top-headlines?country=in&category=sports")
        Call<News> getNews(
