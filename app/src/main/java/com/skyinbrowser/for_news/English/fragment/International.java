...
public class International extends Fragment implements  SwipeRefreshLayout.OnRefreshListener{
    ...
    public static International getInstance(String title) {
        International sf = new International();
        return sf;
    }
    ...
    private void loadData(){
        ...
        Gson gson = new Gson();
        if (preferences.contains("interNews")){
            String json = preferences.getString("interNews", null);
    ...
    private void saveData(){
        ...
        editor.putString("interNews",json);
        editor.apply();
    }
