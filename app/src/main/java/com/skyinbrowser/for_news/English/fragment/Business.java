...
public class Business extends Fragment implements  SwipeRefreshLayout.OnRefreshListener{
    ...
    public static Business getInstance(String title) {
        Business sf = new Business();
        return sf;
    }
    ...
    private void loadData(){
        ...
        Gson gson = new Gson();
        if (preferences.contains("businessNews")){
            String json = preferences.getString("businessNews", null);
    ...
    private void saveData(){
        ...
        editor.putString("businessNews",json);
        editor.apply();
    }
