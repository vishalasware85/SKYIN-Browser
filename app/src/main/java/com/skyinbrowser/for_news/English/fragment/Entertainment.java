...
public class Entertainment extends Fragment implements  SwipeRefreshLayout.OnRefreshListener{
    ...
    public static Entertainment getInstance(String title) {
        Entertainment sf = new Entertainment();
        return sf;
    }
    ...
    private BroadcastReceiver scrollUp = new BroadcastReceiver() {
        @Override
    ...
    private void loadData(){
        ...
        Gson gson = new Gson();
        if (preferences.contains("entertainNews")){
            String json = preferences.getString("entertainNews", null);
    ...
    private void saveData(){
        ...
        editor.putString("entertainNews",json);
        editor.apply();
    }
    ...
    private interface topHeadlinesApi {
        ...
        @GET("top-headlines?country=in&category=entertainment")
        Call<News> getNews(
