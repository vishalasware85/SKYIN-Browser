...
public class Health extends Fragment implements  SwipeRefreshLayout.OnRefreshListener{
    ...
    public static Health getInstance(String title){
    ...
    private void loadData(){
        ...
        Gson gson = new Gson();
        if (preferences.contains("healthNews")){
            String json = preferences.getString("healthNews", null);
    ...
    private void saveData(){
        ...
        editor.putString("healthNews",json);
        editor.apply();
    }
