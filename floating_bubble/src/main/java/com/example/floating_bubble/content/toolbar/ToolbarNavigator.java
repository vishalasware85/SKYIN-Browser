 ...
 */
package com.example.floating_bubble.content.toolbar;
...
import com.example.floating_bubble.R;
...
public class ToolbarNavigator extends Navigator implements Content {
    ...
    private Drawable createBackArrowDrawable() {
        ...
        int[] attrIds = new int[] { androidx.appcompat.R.attr.colorControlNormal };
